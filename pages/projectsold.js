      ...
      <SessionContext.Consumer>
        {(session) => (
          <div className="grid 2xl:grid-cols-5 xl:grid-cols-4 min-h-screen relative pb-10 ">
            ...
            />
            <div className="     2xl:col-span-4 xl:col-span-3 bg-white dark:bg-gray-900  ">
            ...
            <div className=" col-span-1 px-6 py-4 bg-white dark:bg-gray-900 border-l dark:border-gray-800">
