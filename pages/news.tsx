...
export default function App() {
  ...
  return (
    <div className="scrollbar black scrollbarY space-y-5 overflow-auto   px-4 py-4 xl:px-10">
      <div className="h-partial space-y-3 ">
        ...
        <div className="flex 2xl:h-2/3 3xl:h-1/2 space-x-4">
          {news ? (
            <>
